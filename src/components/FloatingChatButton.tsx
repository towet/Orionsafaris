      ...
      <AnimatePresence>
        {isOpen && (
          <div className="flex flex-col items-center gap-3 mb-3">
            ...
            {/* Email */}
            <motion.a
              href="mailto:frankyfreaky103@gmail.com?subject=Safari%20Inquiry"
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-6 h-6">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69.01-.04.01-.08-.02-.11-.08-.05-.14-.03-.21.02-.09.06-1.48.95-4.17 2.7-.39.27-.75.4-1.08.39-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55.29-.1 3.64-1.77 7.06-3.47.34-.14.66-.27.93-.36.54-.18 1.04-.36 1.49-.35.16.0.52.07.76.38.16.22.15.52.13.64-.01.04-.01.09-.02.14z"/>
              </svg>
            </motion.a>
