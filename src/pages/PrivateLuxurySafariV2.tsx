  ...
  const highlights = [
    {
      ...
      description: "Search for lions, leopards, elephants, buffalo, and rhinos (plus cheetahs and hippos) in a 1,510 km² wilderness.",
      icon: Binoculars
    },
    {
      title: "Amboseli & Kilimanjaro",
      description: "Watch herds of 1,000+ elephants against Mount Kilimanjaro and capture its reflection in the wetlands.",
      icon: Tent
    },
    {
    ...
    {
      title: "Sundowners & Stay",
      description: " Enjoy cocktails a top Observation Hill at sunset, starlit dinners, and comfortable full-board lodging in luxury tents and mid-range lodges.",
      icon: Users
    }
  ];
                ...
                {activePricingTab === 'peak' && (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-4">
                        <div className="flex items-end gap-1 mb-2">
                          <span className="text-3xl font-bold text-amber-600">$1,800</span>
                        </div>
                        <p className="text-xs text-stone-500">total package price</p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="p-4">
                        <div className="flex items-end gap-1 mb-2">
                          <span className="text-3xl font-bold text-amber-600">$840</span>
                          <span className="text-sm text-stone-600 mb-1">pp</span>
                        </div>
                        <p className="text-xs text-stone-500">per person</p>
                      </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between relative z-10">
                <div>
                  ...
                  <p className="text-amber-100">Exclusive safari with stunning views of Mt. Kilimanjaro</p>
                </div>
              </div>
            </motion.div>
