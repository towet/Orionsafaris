...
const MigrationSafari = () => {
  ...
  const highlights = [
    {
      title: "Tree-Climbing Lions at Lake Manyara",
      description: " See lions lounging in acacia trees with the Rift Valley as a backdrop.",
      icon: Binoculars
    },
    {
      title: "Cultural Encounter",
      description: "Visit a Maasai village for beadwork, spear-throwing, and local customs.",
      icon: Tent
    },
    {
      title: "  Birdlife & Flamingos:",
      description: "Photograph pink flamingo flocks and 400+ bird species in Lake Manyara and Ngorongoro.",
      icon: Camera
    },
    {
      title: " Small Groups & Impact",
      description: "Travel in groups of 6–12, with part of your fee supporting conservation and community projects.",
      icon: Users
    }
  ];
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              Journey through Tanzania’s legendary Northern Circuit: marvel at tree-climbing lions along Lake Manyara’s shimmering shores, witness the endless plains of the Serengeti teeming with wildlife, and descend into the “Garden of Eden” that is Ngorongoro Crater—all in just five unforgettable days.
